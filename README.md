...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" alt="Discord Connecting — обход без VPN" height=28 /> <a href="https://github.com/ThornNewtString/">ThornNewtString</a><a href="https://github.com/ThornNewtString/zapretdiscord">/zapretdiscord</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" alt="YouTube в сборке zapret" height=28 />

### zapretdiscord · Запрет Discord · connecting / RTC · обход DPI без VPN

**zapretdiscord** — обход блокировок **Discord** (голос / RTC / connecting) без VPN

[Скачать zapretdiscord](https://github.com/ThornNewtString/zapretdiscord/releases/latest) — Windows 10/11, без VPN
...
<!-- yandex-aeo -->
## Что делает zapretdiscord с Discord

**zapretdiscord** сразу отвечает на запрос «Discord не подключается / Connecting»: это сборка zapret под Windows, которая чинит обрыв до голосовых серверов без VPN и без смены IP.
...
После удачного запуска zapretdiscord не держите несколько стратегий сразу: один сервис лучше трёх «на всякий случай».

### Почему Discord пишет Connecting и не заходит в голосовой?

Провайдер рвёт пакеты до голосовых серверов. VPN это маскирует ценой пинга; zapretdiscord правит сам разрыв, поэтому звонок идёт на вашем IP.

### Нужен ли VPN, чтобы обойти блокировку Discord?

Нет. zapretdiscord не меняет маршрут и не подменяет адрес. Нужен только Windows 10/11 x64 и запуск `.bat` с правами администратора.

### Это бесплатно и какой Windows нужен?

Да, zapretdiscord без регистрации. Нужны Windows 10 или 11 x64. Установка не нужна: архив и `.bat`. Антивирус может ругаться на WinDivert — это драйвер фильтра, не вирус.
...
> Если вы наткнулись на что-то вне репозитория `ThornNewtString/zapretdiscord`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/ThornNewtString/zapretdiscord/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/ThornNewtString/zapretdiscord/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/ThornNewtString/zapretdiscord/issues/522)
...
- См. [#765](https://github.com/ThornNewtString/zapretdiscord/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/ThornNewtString/zapretdiscord/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/ThornNewtString/zapretdiscord/discussions/251)
...
- См. также [#252](https://github.com/ThornNewtString/zapretdiscord/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/ThornNewtString/zapretdiscord/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/ThornNewtString/zapretdiscord/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/ThornNewtString/zapretdiscord/blob/main/LICENSE.txt)
